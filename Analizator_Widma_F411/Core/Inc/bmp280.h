...
typedef struct
{
	I2C_HandleTypeDef 	*bmp_i2c; // handler/uchwyt do uzywanego I2C, np. I2C1
	uint8_t				Address; // adres czujnika (7-bitowy)

	// rejestry kalibracyjne
	int16_t t2, t3, p2, p3, p4, p5, p6, p7, p8, p9;
	uint16_t t1, p1;

	int32_t t_fine; // do przeliczania temperatury i cisnienia
